...
<thead>
<tr><th>id</th><th>Name</th><th>Quantity</th><th>ME</th><th>PE</th><th>Copy?</th><th>Margin(ish)</th><th>Isk/hr ish</th><th>POS isk/hr</th><th>POS isk/hr - DCs</th></tr>
</thead>
<tbody>
<?
...
#$detailsql="select portionSize,productionTime,productivityModifier from invTypes join invBlueprintTypes on (invTypes.typeid=invBlueprintTypes.producttypeid) where typeid=:typeid";
...
echo "<tr><td>".$typeid."</td><td><a href=\"/blueprints/".$productlookup[$typeid]."/$me/$pe\" target='_blank'>".$typenamelookup[$typeid]."</a></td><td>".$inventory[$blueprint]."</td><td>$me</td><td>$pe</td><td>$copy</td><td>\n";
